 ...
 */
package io.github.rosestack.util.tree;

import io.github.rosestack.util.ArrayUtils;
import io.github.rosestack.util.CollectionUtils;
...
public class Tree<T> extends LinkedHashMap<String, Object> implements Node<T> {
    ...
    public Tree(TreeNodeConfig treeNodeConfig) {
        this.treeNodeConfig = treeNodeConfig != null ? treeNodeConfig : TreeNodeConfig.DEFAULT_CONFIG;
    }
